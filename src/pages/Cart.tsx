        ...
        {items.map((item) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[10px] tracking-widest uppercase text-luxury-400 mb-1">{item.product.category}</p>
              <p className="font-serif text-base text-luxury-900 dark:text-luxury-50 mb-1">{item.product.name}</p>
              <p className="text-xs text-luxury-500 mb-1">Size: {item.size} · Qty: {item.quantity}</p>
              <p className="text-sm font-light text-luxury-900 dark:text-luxury-50">${item.product.price * item.quantity}</p>
            </div>
            <button
